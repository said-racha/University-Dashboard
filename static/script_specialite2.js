actualiserDonnees_spe2();

////////////////SPECIALITE_2/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

function actualiserDonnees_spe2(){
	
	//*****************************GroupedBar************************************ */
	httpRequest_spe_GroupedBar1 = new XMLHttpRequest();	
	httpRequest_spe_GroupedBar1.open('GET', '/api/spe-GroupedBar2');
	...
	httpRequest_spe_carteMoy1.open('GET', '/api/spe-CarteMoy2');
	...
	httpRequest_spe_admis1.open('GET', '/api/spe-admis2-2021');
...
{   httpRequest_spe_admis1 = new XMLHttpRequest();	
	httpRequest_spe_admis1.open('GET', '/api/spe-admis2-2019');
	httpRequest_spe_admis1.onreadystatechange = function () {
		if (httpRequest_spe_admis1.readyState === 4 && httpRequest_spe_admis1.status === 200) {
			jsonData1 = JSON.parse(httpRequest_spe_admis1.response);
...
{   httpRequest_spe_admis1 = new XMLHttpRequest();	
	httpRequest_spe_admis1.open('GET', '/api/spe-admis2-2020');
	httpRequest_spe_admis1.onreadystatechange = function () {
		if (httpRequest_spe_admis1.readyState === 4 && httpRequest_spe_admis1.status === 200) {
			jsonData1 = JSON.parse(httpRequest_spe_admis1.response);
