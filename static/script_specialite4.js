actualiserDonnees_spe4();

////////////////SPECIALITE_4/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

function actualiserDonnees_spe4(){
	
	//*****************************GroupedBar************************************ */
	httpRequest_spe_GroupedBar1 = new XMLHttpRequest();	
	httpRequest_spe_GroupedBar1.open('GET', '/api/spe-GroupedBar4');
	...
	httpRequest_spe_carteMoy1.open('GET', '/api/spe-CarteMoy4');
	...
	httpRequest_spe_admis1.open('GET', '/api/spe-admis4-2021');
...
{   httpRequest_spe_admis1 = new XMLHttpRequest();	
	httpRequest_spe_admis1.open('GET', '/api/spe-admis4-2019');
	httpRequest_spe_admis1.onreadystatechange = function () {
		if (httpRequest_spe_admis1.readyState === 4 && httpRequest_spe_admis1.status === 200) {
			jsonData1 = JSON.parse(httpRequest_spe_admis1.response);
...
{   httpRequest_spe_admis1 = new XMLHttpRequest();	
	httpRequest_spe_admis1.open('GET', '/api/spe-admis4-2020');
	httpRequest_spe_admis1.onreadystatechange = function () {
		if (httpRequest_spe_admis1.readyState === 4 && httpRequest_spe_admis1.status === 200) {
			jsonData1 = JSON.parse(httpRequest_spe_admis1.response);
