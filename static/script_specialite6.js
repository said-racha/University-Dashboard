actualiserDonnees_spe6();

////////////////SPECIALITE_6/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

function actualiserDonnees_spe6(){
	
	//*****************************GroupedBar************************************ */
	httpRequest_spe_GroupedBar1 = new XMLHttpRequest();	
	httpRequest_spe_GroupedBar1.open('GET', '/api/spe-GroupedBar6');
	...
	httpRequest_spe_carteMoy1.open('GET', '/api/spe-CarteMoy6');
	...
	httpRequest_spe_admis1.open('GET', '/api/spe-admis6-2021');
...
{   httpRequest_spe_admis1 = new XMLHttpRequest();	
	httpRequest_spe_admis1.open('GET', '/api/spe-admis6-2019');
	httpRequest_spe_admis1.onreadystatechange = function () {
		if (httpRequest_spe_admis1.readyState === 4 && httpRequest_spe_admis1.status === 200) {
			jsonData1 = JSON.parse(httpRequest_spe_admis1.response);
...
{   httpRequest_spe_admis1 = new XMLHttpRequest();	
	httpRequest_spe_admis1.open('GET', '/api/spe-admis6-2020');
	httpRequest_spe_admis1.onreadystatechange = function () {
		if (httpRequest_spe_admis1.readyState === 4 && httpRequest_spe_admis1.status === 200) {
			jsonData1 = JSON.parse(httpRequest_spe_admis1.response);
